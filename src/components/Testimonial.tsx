        ...
        <section className="max-w-5xl mx-auto w-full px-10 py-10">
          <div className="flex items-center justify-center flex-col mb-8 gap-y-2 py-5">
            <h2 className="text-2xl  md:text-3xl lg:text-5xl font-bold  text-center text-white">
              Heres what our
              <span className="text-[#683ce7]"> customers</span> have to say
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 w-full">
            <div className="border p-7 rounded-xl bg-[#160d30] drop-shadow-md border-neutral-800/50 col-span-2 flex flex-col gap-y-10 justify-between">
            ...
            <div className="border p-7 rounded-xl bg-[#160d30] drop-shadow-md border-neutral-800/50 col-span-3 flex flex-col gap-y-10 justify-between">
              <div className="flex flex-col gap-y-3.5">
                <p className="font-bold text-xl text-white">
