        ...
        <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
          <label className="block">
            ...
            <input
              ...
              className="block w-full rounded-md shadow-sm focus:ring focus:ring-opacity-75 bg-[#292326] h-12"
            />
          </label>
          <label className="block">
          ...
          <label className="block">
            ...
            <textarea className="block w-full rounded-md focus:ring focus:ring-opacity-75 bg-[#292326] h-20"></textarea>
          </label>
          <button
            type="button"
